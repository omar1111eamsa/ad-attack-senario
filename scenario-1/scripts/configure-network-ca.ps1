# Network Configuration Script for Certificate Authority
# Run this in PowerShell as Administrator on the CA VM

Write-Host "Configuring network adapter for CA..." -ForegroundColor Green
...
if ($adapter) {
    ...
    New-NetIPAddress -InterfaceIndex $adapter.ifIndex -IPAddress 192.168.58.20 -PrefixLength 24
    ...
    Write-Host "IP Address: 192.168.58.20" -ForegroundColor Cyan
