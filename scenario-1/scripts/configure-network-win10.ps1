# Network Configuration Script for Windows 10 Client
# Run this in PowerShell as Administrator on the Win10 VM

Write-Host "Configuring network adapter for Win10..." -ForegroundColor Green
...
if ($adapter) {
    ...
    New-NetIPAddress -InterfaceIndex $adapter.ifIndex -IPAddress 192.168.58.40 -PrefixLength 24
    ...
    Write-Host "IP Address: 192.168.58.40" -ForegroundColor Cyan
    ...
    Test-Connection -ComputerName 192.168.58.10 -Count 2
} else {
